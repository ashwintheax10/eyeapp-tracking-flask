...
LEFT  = [33,160,158,133,153,144]        # eye‑lid landmarks
RIGHT = [362,385,387,263,373,380]
L_IRIS= [468,469,470,471]               # iris outlines
...
def gen_frames():
    ...
    while cam.isOpened():
        ...
        if res.multi_face_landmarks:
            ...
            for arr in (irisL, irisR):
                cv2.polylines(frame,[arr.astype(int)],True,(0,255,0),1)
